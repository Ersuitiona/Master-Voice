      ...
      <div className="space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs flex items-center gap-2 transition-all shadow-md self-start sm:self-auto"
          >
            ...
            return (
              ...
              >
                ...
                <div className="space-y-2 pt-1">
                  ...
                  {m.completed ? (
                    <div className="pt-1 flex items-center justify-between text-xs text-emerald-400 font-bold">
                      <span className="flex items-center gap-1 text-[11px]">
                        <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" /> Milestone Completed!
                      </span>
                    ...
                    <div className="pt-1 flex items-center justify-between text-[11px] text-slate-400">
                      <span>Complete in practice call</span>
                      <span className="text-indigo-400 hover:underline cursor-pointer font-medium" onClick={() => onNavigateTab('practice')}>
                        Start →
                      </span>
                    </div>
                  )}
